 ...
 */
$databases['default']['default'] = [
  'database' => 'darren_oh_name',
  'username' => 'darrenoh',
  'password' => 'LZs-597-mr2-tyH',
  'prefix' => '',
  'host' => 'mysql.darren.oh.name',
  'port' => '3306',
 ...
 * @endcode
 */
$settings['hash_salt'] = 'HhucokZYcwUkjiBDgQWOzprCIuf-ghGQowGajfZXYoVoduJePgPvZdyuxVbfCFeQTZtuN92Aqg';
 ...
 */
$settings['file_private_path'] = realpath($app_root . '/../../private/darren.oh.name');
...
$settings['filecache']['directory']['default'] = $settings['file_private_path'] . '/filecache';
